...
!!! info "Additional resources to set-up and learn Modelica"
    1. [Modelica Official Documentation](https://modelica.org/language/)

    2. [Official Website for OpenModelica](https://openmodelica.org)

    3. [Documentation for Modelica Standard Library](https://modelica.org/libraries/)

    4. [Modelica By Examples by Micheal Tiller](https://mbe.modelica.university/)

    5. [Other books on Modelica](https://modelica.org/publications/books/)
